        ...
        <nav className="px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Forms --> */}
              <SidebarLinkGroup
                activeCondition={pathname === "/" || (pathname && pathname.includes("dashboard"))}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/admin/dashboard/job/profession"
                          ...
                          <li>
                            <Link
                              href="/admin/dashboard/job/skills"
                          ...
                          <li>
                            ...
                            <Link
                              href="/admin/dashboard/job/organization"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/forms/form-layout" &&
                                "text-white"
                                } `}
                            >
                          ...
                          <li>
                            ...
                            <Link
                              href="/admin/dashboard/job/salary-type"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/forms/form-layout" &&
                                "text-white"
                                } `}
                            >
                          ...
                          <li>
                            ...
                            <Link
                              href="/admin/dashboard/job/education"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/forms/form-layout" &&
                                "text-white"
                                } `}
                            >
                          ...
                          <li>
                            ...
                            <Link
                              href="/admin/dashboard/job/experience"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/forms/form-layout" &&
                                "text-white"
                                } `}
                            >
                          ...
                          <li>
                            ...
                            <Link
                              href="/admin/dashboard/job/team-size"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/forms/form-layout" &&
                                "text-white"
                                } `}
                            >
                          ...
                          <li>
                            ...
                            <Link
                              href="/admin/dashboard/job/job-type"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/forms/form-layout" &&
                                "text-white"
                                } `}
                            >
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-book-type"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20" /><path d="M16 8V6H8v2" /><path d="M12 6v7" /><path d="M10 13h4" /></svg>
                        Language
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && "rotate-180"
                            }`}
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-right-from-line"><path d="M3 5v14" /><path d="M21 12H7" /><path d="m15 18 6-6-6-6" /></svg>
                        Others
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && "rotate-180"
                            }`}
